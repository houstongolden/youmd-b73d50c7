...
const Pricing = () => (
  <section id="pricing" className="py-24 md:py-32">
    <div className="max-w-xl mx-auto px-6">
      ...
      <div className="space-y-6">
        ...
        <FadeUp delay={0}>
          <div className="border border-border rounded p-6">
            <div className="flex items-baseline justify-between mb-4">
              ...
              <span className="text-foreground text-[20px] font-mono font-light">
                $0<span className="text-muted-foreground/30 text-[10px] ml-1">/forever</span>
              </span>
            </div>
            <div className="space-y-2 text-[11px] text-muted-foreground mb-5">
        ...
        <FadeUp delay={0.08}>
          <div className="border border-accent/30 rounded p-6">
            ...
            <div className="flex items-baseline justify-between mb-4">
              <span className="text-muted-foreground text-[10px]">For power users.</span>
              <span className="text-foreground text-[20px] font-mono font-light">
            ...
            <p className="text-muted-foreground/25 text-[9px] text-center mt-2 font-mono">
      ...
      <FadeUp delay={0.15}>
        <p className="text-muted-foreground/30 text-[10px] text-center mt-10 font-mono">
