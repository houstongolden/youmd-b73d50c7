  ...
  <div className="p-8 max-w-xl mx-auto">
    ...
    <div className="terminal-panel mb-6">
      <div className="p-4 text-center">
        <pre className="font-mono text-[8px] leading-[1.1] text-accent/60 inline-block text-left">
{`    ░░▒▒▓▓██▓▓▒▒░░    
  ░▒▓██████████████▓▒░  
  ▒███    ████    ███▒  
  ▓██  ●  ████  ●  ██▓  
  ...
  ░▒▓██████████████▓▒░  
    ...
    {/* Identity */}
    <div className="mb-1">
      <h1 className="font-mono text-lg text-foreground">@{username}</h1>
      <p className="font-mono text-[13px] text-muted-foreground/70 mt-1">
    ...
    <div className="grid grid-cols-3 gap-4 mb-2">
      {[
        ...
        <div key={m.label} className="terminal-panel p-3">
          <p className="font-mono text-[10px] text-muted-foreground/50 uppercase">{m.label}</p>
          <p className="font-mono text-lg text-foreground mt-1">{m.value}</p>
        </div>
      ))}
    </div>
    ...
    <div className="space-y-2">
      {[
        ...
        <div key={s.name} className="flex items-center justify-between font-mono text-[12px]">
    ...
    {mode === "private" && (
      <>
        ...
        <div className="terminal-panel p-4">
          ...
          <div className="mt-3 space-y-2 font-mono text-[12px] text-foreground/60">
    ...
    <div className="space-y-1.5">
      {[
        ...
        <div key={f.key} className="flex items-center justify-between font-mono text-[12px]">
