...
const BillingPane = () => (
  <div className="p-8 max-w-xl mx-auto">
    <div className="flex items-center gap-2 mb-6">
      <span className="font-mono text-[11px] text-muted-foreground/40">*/billing</span>
    </div>

    <h2 className="font-mono text-base text-foreground mb-6">billing & usage</h2>
    ...
    <div className="terminal-panel p-5 mb-2">
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="font-mono text-sm text-accent">$29/mo</span>
      </div>
      <div className="space-y-1.5 font-mono text-[11px] text-muted-foreground/60">
    ...
    <div className="terminal-panel p-4">
      {[
        ...
        <div key={i} className="flex items-center justify-between font-mono text-[12px] py-2 border-b border-border/50 last:border-0">
